...
# ╔═╡ 7fc76831-7539-4ce0-aec9-4bda9908fb87


# ╔═╡ 79d4a450-305f-41b8-bd11-3d3792f2dbc1
function bisect_method(f, a, b, tolerance, max_no_iter)
	fa = f(a)
	for i ∈ 1:max_no_iter
		p = a + (b - a)/2
		fp = f(p)
	...
	throw(ArgumentError("Method failed after $max_no_iter iterations"))
end
